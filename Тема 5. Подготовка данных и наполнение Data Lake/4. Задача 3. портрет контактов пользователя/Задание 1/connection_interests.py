...
# /user/mustdayker/data/analytics/connection_interests_d7

# /usr/lib/spark/bin/spark-submit --master yarn --deploy-mode cluster /lessons/connection_interests.py 2022-05-25 7 /user/mustdayker/data/events /user/mustdayker/data/analytics/user_interests_d7 /user/master/data/snapshots/tags_verified/actual /user/mustdayker/data/analytics/connection_interests_d7