...
calculate_user_interests('2022-04-04', 5, spark).write.parquet('/user/mustdayker/data/tmp/user_interests_04_04_5')
calculate_user_interests('2022-05-04', 5, spark).write.parquet('/user/mustdayker/data/tmp/user_interests_05_04_5')
calculate_user_interests('2022-04-04', 1, spark).write.parquet('/user/mustdayker/data/tmp/user_interests_04_04_1')
